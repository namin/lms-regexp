...
// TR compile entry point
    ...
    def compileREStub(str: String, global: String, flat: Boolean): RECompiled = {
      ...
      regexp.startNode = pstate.result.asInstanceOf[scala.virtualization.lms.regexp.backtrack.RENode]
    ...
    def compileRE(str: String, global: String, flat: Boolean): RECompiled =
    {
        ...
        state.result = pstate.result.asInstanceOf[scala.virtualization.lms.regexp.backtrack.RENode]
