...
var x13 = null.asInstanceOf[scala.lms.regexp.Automaton[Char, Byte]]
var x1 = null.asInstanceOf[scala.Function1[Char, scala.lms.regexp.Automaton[Char, Byte]]]
var x17 = null.asInstanceOf[scala.lms.regexp.Automaton[Char, Byte]]
...
var x12 = null.asInstanceOf[scala.lms.regexp.Automaton[Char, Byte]]
x1 = {x2: (Char) => 
val x3 = x2 == 'A'
val x18 = if (x3) {
x17
...
x12 = scala.lms.regexp.Automaton(1.toByte,x1)
x7 = {x8: (Char) => 
val x9 = x8 == 'A'
val x15 = if (x9) {
x10
...
x17 = scala.lms.regexp.Automaton(0.toByte,x4)
x13 = scala.lms.regexp.Automaton(0.toByte,x1)
x13
}
}
/*****************************************
